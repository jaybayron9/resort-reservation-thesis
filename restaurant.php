...
<head>
    ...
    <title>Beatriz Rafaela Resort - Restaurant</title>
    <style>
        /* Reset */
        * {
            margin: 0;
...
<body>
    ...
    <div class="restaurant-section">
        <h1>RESTAURANT</h1>
        <p>Indulge in a culinary journey at our on-site restaurant, where we offer a perfect blend of local flavors and international cuisine. Enjoy a range of dishes crafted with the freshest ingredients, all while taking in the beautiful views of the ocean. Whether you're here for a casual meal or a romantic dinner, our restaurant promises a dining experience like no other.</p>

        <!-- Image Gallery with Three Images -->
        <div class="image-gallery">
            <img src="PNGS/restaurant.jpg" alt="Restaurant Interior" class="restaurant-image">
            <img src="PNGS/restaurant2.jpg" alt="Ocean View Dining" class="restaurant-image">
            <img src="PNGS/restaurant3.jpg" alt="Delicious Cuisine" class="restaurant-image">
        </div>
