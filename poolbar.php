...
<head>
    ...
    <title>Beatriz Rafaela Resort - Pool Bar</title>
    <style>
        /* Reset */
        * {
            margin: 0;
...
<body>
    ...
    <!-- Pool Bar Section -->
    <div class="poolbar-section">
        <h1>POOL BAR</h1>
        <p>Unwind and relax at our Pool Bar, where refreshing drinks and light bites await you. Whether you want to enjoy a tropical cocktail by the poolside or sip on an ice-cold beverage while enjoying the sunset, our pool bar offers the perfect setting for any occasion. Join us for a refreshing experience at one of the most scenic spots in the resort!</p>

        <!-- Image Gallery with Three Images -->
        <div class="image-gallery">
            <img src="PNGS/poolbar.jpg" alt="Pool Bar Overview" class="poolbar-image">
            <img src="PNGS/poolbar1.jpg" alt="Cocktail by the Pool" class="poolbar-image">
            <img src="PNGS/poolbar2.jpg" alt="Chilled Beverages at Pool Bar" class="poolbar-image">
        </div>
