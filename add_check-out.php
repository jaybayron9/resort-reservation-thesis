...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkin_id = mysqli_real_escape_string($conn, $_POST['checkin_id']);
    $checkout_bill = mysqli_real_escape_string($conn, $_POST['checkout_bill']);
    $checkout_payment = mysqli_real_escape_string($conn, $_POST['checkout_payment']);


    $sql = "INSERT INTO `check-out` (CheckInID, CheckOutBill, CheckOutPayment) VALUES ('$checkin_id', '$checkout_bill', '$checkout_payment')";
...
<div class="container">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        <input type="text" id="checkin_id" name="checkin_id" required><br><br>
        <label for="checkout_bill">CheckOut Bill:</label><br>
        <input type="text" id="checkout_bill" name="checkout_bill" required><br><br>
        <label for="checkout_payment">CheckOut Payment:</label><br>
        <input type="text" id="checkout_payment" name="checkout_payment" required><br><br>
