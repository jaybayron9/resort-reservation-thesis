...
$sql = "SELECT * FROM services WHERE ServicesID = ?";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE services SET ServicesName = ?, ServicesType = ?, ServicesPrice = ?, ServicesDescription = ? WHERE ServicesID = ?";
    $stmt = $pdo->prepare($sql); 
    $stmt->bindParam(1, $serviceName, PDO::PARAM_STR);
    $stmt->bindParam(2, $serviceType, PDO::PARAM_STR);
    $stmt->bindParam(3, $servicePrice, PDO::PARAM_INT);
    $stmt->bindParam(4, $serviceDescription, PDO::PARAM_STR);
